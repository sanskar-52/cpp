...
// how many subarray will include ith index value in a given subarray?
// let the value be at 6th index and we have to find to how many subarray will include 6th index value
// from 2th index to 8th index subarray.
// 2th to 6th will be  5  and 6th to 8th will be  3
// so 5 * 3 = 15 subarray will be there from 2th index to 8th index that can include 6th index value in it.
